...
router = APIRouter(prefix="/okx/account", tags=["OKX Account"])

def get_account_service() -> OKXAccountService:
    services = get_services()
    return services.okx_account_service

@router.get("/info",
    summary="Get Account Information",
    description="Get account overview information")
async def get_account_info(
    account_service: OKXAccountService = Depends(get_account_service)
):
    """
...
async def get_balances(
    ccy: Optional[str] = Query(default=None, description="Currency filter"),
    account_service: OKXAccountService = Depends(get_account_service)
):
    """
